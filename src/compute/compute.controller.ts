...
export class ComputeController {
  ...
  createComputeResult(@Body() createComputeResultDto: CreateComputeResultDto): ComputeResultResponseDto {
  ...
  @Get('result/:id')
  getComputeResult(@Param('id') id: string): ComputeResultResponseDto | undefined {
  ...
  verifyComputeResult(@Param('id') id: string, @Body() body: { result: string }): { isValid: boolean } {
